/*import * as dummy1 from '../../img/dummy10x20.jpg';
import * as dummy2 from '../../img/dummy20x10.jpg';
import * as dummy3 from '../../img/dummy100x200.jpg';
import * as dummy4 from '../../img/dummy200x100.jpg';
import * as dummy5 from '../../img/dummy500x1000.jpg';
import * as dummy6 from '../../img/dummy1000x500.jpg';
import * as dummy7 from '../../img/dummy1500x3000.jpg';
import * as dummy8 from '../../img/dummy3000x1500.jpg';

export const imgsDummLocal = [
    dummy1.default,
    dummy2.default,
    dummy3.default,
    dummy4.default,
...
export const arrayCArte = [
    {
        id : 1,
        srcImg : imgsURLcArte[6],
        srcName : "Frangipani Flowers",
        srcBDay : "24/03/2023",
        srcDesc : `Esta imagem é de minha autoria. Estou usando-a para exemplificar
        um desenho. Descrição do desenho Descrição do desenho Descrição do desenho
        Descrição do desenho Descrição do desenho`,
        srcFerr : ['Medibang','Blender'],
        srcTema : ['Outros','Esboços']
    },
    {
        id : 2,
        srcImg : imgsURLcArte[15],
        srcName : "Garden of Hydrangeas",
        srcBDay : "23/03/2023",
        srcDesc : `Esta imagem é de minha autoria. Estou usando-a para exemplificar
        um desenho. Descrição do desenho Descrição do desenho Descrição do desenho
        Descrição do desenho Descrição do desenho`,
        srcFerr : ['Blender','MSPaint'],
        srcTema : ['Cartoons','Esboços']
    },
    {
        id : 3,
        srcImg : imgsURLcArte[1],
        srcName : "Autumn Leaves",
        srcBDay : "22/03/2023",
        srcDesc : `Esta imagem é de minha autoria. Estou usando-a para exemplificar
        um desenho. Descrição do desenho Descrição do desenho Descrição do desenho
        Descrição do desenho Descrição do desenho`,
        srcFerr : ['MSPaint','MediBang'],
        srcTema : ['Medievais']
    },
    {
        id : 4,
        srcImg : imgsURLcArte[13],
        srcName : "Winter Leaves",
        srcBDay : "21/03/2023",
        srcDesc : `Esta imagem é de minha autoria. Estou usando-a para exemplificar
        um desenho. Descrição do desenho Descrição do desenho Descrição do desenho
        Descrição do desenho Descrição do desenho`,
        srcFerr : ['MediBang'],
        srcTema : ['Cartoons','Outros']
    },
    {
        id : 5,
        srcImg : imgsURLcArte[17],
        srcName : "Coolest Koala",
        srcBDay : "20/03/2023",
        srcDesc : `Esta imagem é de minha autoria. Estou usando-a para exemplificar
        um desenho. Descrição do desenho Descrição do desenho Descrição do desenho
        Descrição do desenho Descrição do desenho`,
        srcFerr : ['Blender'],
        srcTema : ['Medievais','Outros']
    },
    {
        id : 6,
        srcImg : imgsURLcArte[0],
        srcName : "Special Clown",
        srcBDay : "11/04/2023",
        srcDesc : `Esta imagem não é de minha autoria. Estou usando-a para fingir
        um desenho. Descrição do desenho Descrição do desenho Descrição do desenho
        Descrição do desenho Descrição do desenho`,
        srcFerr : ['MSPaint'],
        srcTema : ['Outros','Esboços']
